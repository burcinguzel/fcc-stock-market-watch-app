...
# FCC - STOCK MARKET WATCH APP

## Overview

server.js is the 3rd FreeCodeCamp dynamic web application project.
## Versions
...
```bash
$ git clone https://github.com/burcinguzel/fcc-stock-market-watch-app.git
```
...
For api keys, See (https://www.quandl.com)
